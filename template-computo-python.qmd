...
Andrew will add something mentioning generative modeling, unmodeled and modeled data, graphical models
...
A Bayesian model is nothing more than a joint distribution over parameters $\theta$ and data $y$.
