...
This statement accumulate, term by terms, the log density derived above. The intercept prior normal_lupdf(alpha | 0, 5) contributes $\log \textrm{normal}(\alpha \mid 0, 5)$; the
