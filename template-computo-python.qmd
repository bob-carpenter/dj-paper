...
Bayesian data analysis necessarily involves Bayesian models.  It easy to concisely specify a Bayesian model mathematically using the notation for joint and conditional probability.  Probabilistic programming language (PPL) were developed with the goal of maintaining a clear correspondance between the mathematical specification of the model and its programmatic implementation.
